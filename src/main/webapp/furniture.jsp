...
<%!public static final String GO_TO_BOOKINGREQUEST_PAGE = "/blackwoodalley-web/BookingRequestServlet";%>
    ...
    <main>
                ...
                <div class="furniture-imgs">
                    ...
                    <div class="outer-box">
                        <a href=<%=GO_TO_BOOKINGREQUEST_PAGE%>>
                            <img class="furniture" src="../../assets/images/service1_page/top-one.jpeg" alt="antique">
                    ...
                    <div class="outer-box">
                        <a href=<%=GO_TO_BOOKINGREQUEST_PAGE%>>
                            <img class="furniture" src="../../assets/images/service1_page/top-two.jpeg" alt="antique">
                    ...
                    <div class="outer-box">
                        <a href=<%=GO_TO_BOOKINGREQUEST_PAGE%>>
                            <img class="furniture" src="../../assets/images/service1_page/outdoor.jpeg" alt="antique">
        ...
        <div id="how-it-works">
            ...
            <img class="gallery-imgs" src="../../assets/images/service1_page/working.jpeg" alt="antique">
        ...
        <div id="gallery">
            ...
            <figure>
                ...
                <div class="gallery-box">
                    <img class="gallery-imgs" src="../../assets/images/service1_page/before1.png" alt="antique">
                    <h3>before</h3>
                </div>
                <div class="gallery-box">
                    <img class="gallery-imgs" src="../../assets/images/service1_page/after1.png" alt="antique">
                    <h3>after</h3>
                </div>
                <div class="gallery-box">
                    <img class="gallery-imgs" src="../../assets/images/service1_page/before2.png" alt="antique">
                    <h3>before</h3>
                </div>
                <div class="gallery-box">
                    <img class="gallery-imgs" src="../../assets/images/service1_page/after2.png" alt="antique">
                    <h3>after</h3>
                </div>

                <div class="gallery-box">
                    <img class="gallery-imgs" src="../../assets/images/service1_page/before3.png" alt="antique">
                    <h3>before</h3>
                </div>
                <div class="gallery-box">
                    <img class="gallery-imgs" src="../../assets/images/service1_page/after3.png" alt="antique">
                    <h3>after</h3>
                </div>

                <div class="gallery-box">
                    <img class="gallery-imgs" src="../../assets/images/service1_page/before4.png" alt="antique">
                    <h3>before</h3>
                </div>
                <div class="gallery-box">
                    <img class="gallery-imgs" src="../../assets/images/service1_page/after4.png" alt="antique">
                    <h3>after</h3>
                </div>

                <div class="gallery-box">
                    <img class="gallery-imgs" src="../../assets/images/service1_page/before5.png" alt="antique">
                    <h3>before</h3>
                </div>
                <div class="gallery-box">
                    <img class="gallery-imgs" src="../../assets/images/service1_page/after5.png" alt="antique">
                    <h3>after</h3>
                </div>

                <div class="gallery-box">
                    <img class="gallery-imgs" src="../../assets/images/service1_page/before6.png" alt="antique">
                    <h3>before</h3>
                </div>
                <div class="gallery-box">
                    <img class="gallery-imgs" src="../../assets/images/service1_page/after6.png" alt="antique">
                    <h3>after</h3>
                </div>
                <div class="gallery-box">
                    <img class="gallery-imgs" src="../../assets/images/service1_page/before7.png" alt="antique">
                    <h3>before</h3>
                </div>
                <div class="gallery-box">
                    <img class="gallery-imgs" src="../../assets/images/service1_page/after7.png" alt="antique">
                    <h3>after</h3>
                </div>
                <div class="gallery-box">
                    <img class="gallery-imgs" src="../../assets/images/service1_page/after-last2.jpg" alt="antique">
                    <h3>after</h3>
                </div>
                <div class="gallery-box">
                    <img class="gallery-imgs" src="../../assets/images/service1_page/after-last1.jpeg" alt="antique">
                    <h3>after</h3>
                </div>
